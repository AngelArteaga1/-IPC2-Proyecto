    ...
    <div class="contenedor">
        ...
        <form id="form1" runat="server">
            ...
            <section class="fila">
                ...
                <div class="col-3 der">
                    <div id="down">
                        <asp:Label ID="LblSucc" runat="server" Text="La partida ha sido guardada" CssClass="Succ" Visible="False"></asp:Label>
                        <br />
                        <asp:Button ID="Button1" runat="server" Text="GUARDAR PARTIDA" CssClass="botones" OnClick="Button1_Click" />
                        <br />
